...
__all__ = ["MaskFormerStereoDatasetMapper"]


class MaskFormerStereoDatasetMapper:
    """
    ...
    def __call__(self, dataset_dict):
        ...
        if "sem_seg_file_name" in dataset_dict:
            ...
            sem_seg_gt = np.array(sem_seg_gt)/128.
            sem_seg_gt *= 192/255
            sem_seg_gt.round()
        ...
        # aug_input = T.AugInput(image_left, sem_seg=sem_seg_gt)
